...
export const routes: Routes = [
  // Área pública (comunidad)
  {
    ...
    children: [
      ...
      { path: 'encuestas', loadComponent: () => import('./pages/encuestas/encuestas').then((m) => m.Encuestas) },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'encuestas', loadComponent: () => import('./pages/admin-encuestas/admin-encuestas').then((m) => m.AdminEncuestas) },
